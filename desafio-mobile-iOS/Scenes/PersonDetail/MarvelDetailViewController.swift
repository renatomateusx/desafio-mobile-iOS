...
class MarvelDetailViewController: UIViewController {
    ...
    fileprivate var detailViewModel: MarvelDetailViewModel!
    ...
    public static func createMarvelDetailController(detailViewModel: MarvelDetailViewModel) -> MarvelDetailViewController? {
        let storyboard = UIStoryboard.init(name: "Main", bundle: nil)
        if let vc = storyboard.instantiateViewController(withIdentifier: "MarvelDetailViewController") as? MarvelDetailViewController {
    ...
    fileprivate func setupBindings() {
        ...
        detailViewModel?.fetchPersonDetail()
...
extension MarvelDetailViewController: UICollectionViewDataSource {
...
extension MarvelDetailViewController: UICollectionViewDelegateFlowLayout {
